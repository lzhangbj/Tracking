...
class imdb_vid(object):
    ...
    def rpn_roidb(self, gt_roidb, append_gt=False):
        ...
        if append_gt:
            ...
            roidb = imdb_vid.merge_roidbs(gt_roidb, rpn_roidb)
        else:
    ...
    def create_roidb_from_box_list(self, box_list, gt_roidb):
        ...
        for i in range(self.num_images):
            ...
            overlaps = scipy.sparse.csr_matrix(overlaps)  # overlaps (n_boxes, n_classes) each element is the overlap area of box and class
